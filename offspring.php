<!-- File purpose: Offspring page. Returns all breeding combinations that yield your monster as offspring. -->
...
<body>
	...
	<?php
		...
		$body_image ="offspring.png";
		$body_title = "offspring";
		$body_p = "Returns all breeding combinations that yield your monster as offspring.";
	...
	?>
		...
		<? if ($search): ?>
			...
			<div id="oc4" class="w3-col w3-container">
			  ...
			  ?>
			  <h2 class="table_title"><? echo "Breeding to make " . $keyword; ?></h2>
